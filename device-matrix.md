...
Campaign boards graduated under
[`micropython-hardware`](https://github.com/PyDevices/micropython-hardware)
with the [board devices contract](https://pydisplay.readthedocs.io/en/latest/hardware/board-devices.html):
...
`micropython-hardware/board_configs/`.
