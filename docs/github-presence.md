...
| [audioif](https://github.com/PyDevices/audioif) | CircuitPython-compatible audio for MicroPython plus `pydevices-audioif` CPython/Android/Pyodide wheels | [pydevices.github.io/audioif](https://pydevices.github.io/audioif/) · [TestPyPI](https://test.pypi.org/project/pydevices-audioif/) |
