...
| [lvgl-bindings](https://github.com/PyDevices/lvgl-bindings) | LVGL C→binding generator (source of truth for the native bindings consumers) | [pydevices.github.io/lvgl-bindings](https://pydevices.github.io/lvgl-bindings/) |
...
| [audiodsp](https://github.com/PyDevices/audiodsp) | CircuitPython-compatible audio for MicroPython plus `pydevices-audiodsp` CPython/Android/Pyodide wheels | [pydevices.github.io/audiodsp](https://pydevices.github.io/audiodsp/) · [TestPyPI](https://test.pypi.org/project/pydevices-audiodsp/) |
...
| [pyscript-template](https://github.com/PyDevices/pyscript-template) | Minimal installable PyScript application template | [pydevices.github.io/pyscript-template](https://pydevices.github.io/pyscript-template/) |
