...
- [`mpvst`](https://github.com/PyDevices/mpvst) — A hardware-accurate MicroPython audio engine -- core, effects, and instruments -- packaged as a VST3 sidecar plug-in for building and auditioning racks inside a DAW.
