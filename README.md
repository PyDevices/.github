...
- [`data/repos_db.json`](data/repos_db.json) — **the single source of truth for the repository map**. [`scripts/generate_sites.py`](scripts/generate_sites.py) renders it into every landing page, into [`profile/README.md`](profile/README.md), and into [pydevices/docs/ecosystem.md](https://github.com/PyDevices/pydevices/blob/main/docs/ecosystem.md).
