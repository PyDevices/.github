...
- [`device-matrix.md`](device-matrix.md) — campaign board device matrix (fixture # ↔ board_config ↔ eager/lazy roles).
- [`board-inventory.md`](board-inventory.md) / [`firmware-fixtures.md`](firmware-fixtures.md) / [`pydisplay-display-boards.md`](pydisplay-display-boards.md) — Detect fixtures and display bring-up notes.
...
Org website: <https://pydevices.github.io/>

Device matrix Pages: <https://pydevices.github.io/.github/>
