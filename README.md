...
- [`board-inventory.md`](board-inventory.md) / [`firmware-fixtures.md`](firmware-fixtures.md) / [`pydisplay-display-boards.md`](pydisplay-display-boards.md) — Detect fixtures and display bring-up notes (device roles matrix lives on [micropython-hardware](https://pydevices.github.io/micropython-hardware/)).
